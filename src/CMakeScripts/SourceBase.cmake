...
if(DEFINED WIN32 OR DEFINED WIN64)
	add_definitions(-DCOMPILER_MSVC -D_DLL_EXT=.dll)
elseif(DEFINED POSIX OR DEFINED LINUX32 OR DEFINED LINUX64)
	add_definitions(-DGNUC -DCOMPILER_GCC -D_DLL_EXT=.so)
...
if(DEFINED WIN32)
	...
	set_target_properties(${PROJECT_NAME} PROPERTIES LIBRARY_OUTPUT_DIRECTORY "${WIN32_LIB_OUTPUT_DIR}")
...
elseif(DEFINED WIN64)
	...
	set_target_properties(${PROJECT_NAME} PROPERTIES LIBRARY_OUTPUT_DIRECTORY "${WIN64_LIB_OUTPUT_DIR}")
...
elseif(DEFINED LINUX32)
	...
	set_target_properties(${PROJECT_NAME} PROPERTIES LIBRARY_OUTPUT_DIRECTORY "${LINUX32_LIB_OUTPUT_DIR}")
...
elseif(DEFINED LINUX64)
	...
	set_target_properties(${PROJECT_NAME} PROPERTIES LIBRARY_OUTPUT_DIRECTORY "${LINUX64_LIB_OUTPUT_DIR}")
